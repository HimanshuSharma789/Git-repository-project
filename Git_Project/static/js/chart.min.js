...
!function (t, e) {
  ...
  function l(t) {
    ...
    i = t[1] / 255,
    n = t[2] / 255;
    return [100 * (0.4124 * (e = e > 0.04045 ? Math.pow((e + 0.055) / 1.055, 2.4)  : e / 12.92) + 0.3576 * (i = i > 0.04045 ? Math.pow((i + 0.055) / 1.055, 2.4)  : i / 12.92) + 0.1805 * (n = n > 0.04045 ? Math.pow((n + 0.055) / 1.055, 2.4)  : n / 12.92)),
  ...
  function u(t) {
    ...
    for (var d = 0; d < 3; d++) (n = r + 1 / 3 * - (d - 1)) < 0 && n++,
    n > 1 && n--,
  ...
  function p(t) {
    ...
    o = t[1] / 100,
    r = t[2] / 100;
    return i = - 0.9689 * a + 1.8758 * o + 0.0415 * r,
  ...
  function v(t) {
    ...
    r = t[1],
    s = t[2];
    return o <= 8 ? a = (i = 100 * o / 903.3) / 100 * 7.787 + 16 / 116 : (i = 100 * Math.pow((o + 16) / 116, 3), a = Math.pow(i / 100, 1 / 3)),
    [
  ...
  Y.prototype = {
    ...
    negate: function () {
      for (var t = [
      ], e = 0; e < 3; e++) t[e] = 255 - this.values.rgb[e];
    ...
    clone: function () {
      ...
      n = this.values,
      a = i.values;
      for (var o in n) n.hasOwnProperty(o) && (t = n[o], '[object Array]' === (e = {
  ...
  Y.prototype.setValues = function (t, e) {
    ...
    for (i = 0; i < t.length; i++) n = Math.max(0, Math.min(r[t][i], a[t][i])),
    a[t][i] = Math.round(n);
  ...
  K = {
    ...
    each: function (t, e, i, n) {
      ...
      o,
      r;
      if (K.isArray(t)) if (o = t.length, n) for (a = o - 1; a >= 0; a--) e.call(i, t[a], a);
    ...
    clone: function (t) {
      ...
      if (K.isObject(t)) {
        for (var e = {
        }, i = Object.keys(t), n = i.length, a = 0; a < n; ++a) e[i[a]] = K.clone(t[i[a]]);
        return e
      }
      return t
    },
    ...
    merge: function (t, e, i) {
      ...
      for (n = (i = i || {
      }).merger || K._merger, a = 0; a < d; ++a) if (e = l[a], K.isObject(e)) for (s = 0, r = (o = Object.keys(e)).length; s < r; ++s) n(o[s], t, e, i);
      return t
    },
  ...
  var bt = {
    ...
    advance: function () {
      for (var t, e, i, n, a = this.animations, o = 0; o < a.length; ) e = (t = a[o]).chart,
      i = t.numSteps,
      ...
      ut.callback(t.onAnimationProgress, [
        t
      ], e),
      t.currentStep >= i ? (ut.callback(t.onAnimationComplete, [
        t
      ], e), e.animating = !1, a.splice(o, 1))  : ++o
    }
  },
  ...
  ut.extend(wt.prototype, {
    ...
    update: ut.noop,
    transition: function (t) {
      for (var e = this.getMeta(), i = e.data || [
      ], n = i.length, a = 0; a < n; ++a) i[a].transition(t);
    ...
    setHoverStyle: function (t) {
      ...
      o(a.backgroundColor)], void 0, i),
      a.borderColor = xt([n.hoverBorderColor,
      e.hoverBorderColor,
      o(a.borderColor)], void 0, i),
      a.borderWidth = xt([n.hoverBorderWidth,
      e.hoverBorderWidth,
      a.borderWidth], void 0, i)
    },
  ...
  var Pt = pt.extend({
    draw: function () {
      ...
      d = l.elements.line,
      u = - 1;
      for (this._loop && s.length && s.push(s[0]), o.save(), o.lineCap = a.borderCapStyle || d.borderCapStyle, o.setLineDash && o.setLineDash(a.borderDash || d.borderDash), o.lineDashOffset = Ct(a.borderDashOffset, d.borderDashOffset), o.lineJoin = a.borderJoinStyle || d.borderJoinStyle, o.lineWidth = Ct(a.borderWidth, d.borderWidth), o.strokeStyle = a.borderColor || l.defaultColor, o.beginPath(), u = - 1, t = 0; t < s.length; ++t) e = s[t],
  ...
  var Yt = Mt.extend({
    ...
    getRuler: function () {
      ...
      return {
        min: ut.isNullOrUndef(i.options.barThickness) ? function (t, e) {
          ...
          for (a = 0, o = s.length; a < o; ++a) n = t.getPixelForTick(a),
    ...
    _resolveElementOptions: function (t, e) {
      ...
      for (i = 0, n = h.length; i < n; ++i) d[a = h[i]] = qt([s[a],
      r[a],
      l[a]], u, e);
      return d
    }
  ...
  var Kt = Mt.extend({
    ...
    _resolveElementOptions: function (t, e) {
      ...
      for (i = 0, n = c.length; i < n; ++i) u[a = c[i]] = Xt([s[a],
      r[a],
      l[a]], h, e);
  ...
  st._set('doughnut', {
    ...
    legend: {
      labels: {
        generateLabels: function (t) {
          ...
          return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
            ...
            return {
              text: i,
              fillStyle: Gt([s.backgroundColor,
              o.backgroundColor,
              l.backgroundColor], void 0, n),
              strokeStyle: Gt([s.borderColor,
              o.borderColor,
              l.borderColor], void 0, n),
              lineWidth: Gt([s.borderWidth,
              o.borderWidth,
              l.borderWidth], void 0, n),
      ...
      onClick: function (t, e) {
        ...
        ]).length; i < n; ++i) (a = r.getDatasetMeta(i)).data[o] && (a.data[o].hidden = !a.data[o].hidden);
        r.update()
      }
    },
    cutoutPercentage: 50,
  ...
  var $t = Mt.extend({
    ...
    getMaxBorderWidth: function (t) {
      ...
      if (!t) return 0;
      for (e = 0, i = t.length; e < i; ++e) a = t[e],
    ...
    _resolveElementOptions: function (t, e) {
      ...
      for (i = 0, n = h.length; i < n; ++i) d[a = h[i]] = Gt([s[a],
      r[a],
      l[a]], u, e);
      return d
    },
  ...
  var ne = Mt.extend({
    ...
    _resolvePointOptions: function (t, e) {
      ...
      c = Object.keys(h);
      for (i = 0, n = c.length; i < n; ++i) d[a = c[i]] = te([s[a],
      r[h[a]],
      r[a],
      l[a]], u, e);
      return d
    ...
    updateBezierControlPoints: function () {
      ...
      if (r.spanGaps && (l = l.filter(function (t) {
       ...
       else for (t = 0, e = l.length; t < e; ++t) i = l[t]._model,
      ...
      if (a.options.elements.line.capBezierPoints) for (t = 0, e = l.length; t < e; ++t) i = l[t]._model,
  ...
  st._set('polarArea', {
    ...
    legend: {
      labels: {
        generateLabels: function (t) {
          ...
          return e.labels.length && e.datasets.length ? e.labels.map(function (i, n) {
            ...
            return {
              text: i,
              fillStyle: ae([r.backgroundColor,
              o.backgroundColor,
              s.backgroundColor], void 0, n),
              strokeStyle: ae([r.borderColor,
              o.borderColor,
              s.borderColor], void 0, n),
              lineWidth: ae([r.borderWidth,
              o.borderWidth,
              s.borderWidth], void 0, n),
              hidden: isNaN(o.data[n]) || a.data[n].hidden,
              index: n
            }
          })  : [
      ...
      onClick: function (t, e) {
        ...
        r = this.chart;
        for (i = 0, n = (r.data.datasets || [
        ]).length; i < n; ++i) (a = r.getDatasetMeta(i)).data[o].hidden = !a.data[o].hidden;
        r.update()
      }
    },
    tooltips: {
  ...
  var oe = Mt.extend({
    ...
    update: function (t) {
      ...
      u = r.data;
      for (a._updateRadius(), r.count = a.countVisibleElements(), e = 0, i = o.data.length; e < i; e++) l[e] = s,
      n = a._computeAngle(e),
      d[e] = n,
      s += n;
      for (e = 0, i = u.length; e < i; ++e) u[e]._options = a._resolveElementOptions(u[e], e),
    ...
    _resolveElementOptions: function (t, e) {
      ...
      for (i = 0, n = h.length; i < n; ++i) d[a = h[i]] = ae([s[a],
      r[a],
      l[a]], u, e);
      return d
    },
  ...
  var de = Mt.extend({
    ...
    _resolvePointOptions: function (t, e) {
      ...
      c = Object.keys(h);
      for (i = 0, n = c.length; i < n; ++i) d[a = c[i]] = le([s[a],
      r[h[a]],
      r[a],
      l[a]], u, e);
      return d
    ...
    _resolveLineOptions: function (t) {
      ...
      for (e = 0, i = d.length; e < i; ++e) l[n = d[e]] = le([r[n],
      o[n],
      s[n]]);
    ...
    updateBezierControlPoints: function () {
      ...
      for (t = 0, e = r.length; t < e; ++t) i = r[t]._model,
  ...
  var ve = {
    modes: {
      single: function (t, e) {
        ...
        return ce(t, function (t) {
          if (t.inRange(i.x, i.y)) return n.push(t),
          n
        }),
        n.slice(0, 1)
      },
  ...
  var Ee = {
    ...
    notify: function (t, e, i) {
      ...
      d = l.length;
      for (n = 0; n < d; ++n) if ('function' == typeof (s = (o = (a = l[n]).plugin) [e]) && ((r = [
        t
      ].concat(i || [
      ])).push(a.options), !1 === s.apply(o, r))) return !1;
      return !0
    },
  ...
  var Ze = pt.extend({
    ...
    update: function (t) {
      ...
      if (p.length) {
        ...
        b = function (t, e, i, n) {
          ...
          h = r + s,
          c = l + s;
          return 'right' === d ? a -= e.width : 'center' === d && ((a -= e.width / 2) + e.width > n.width && (a = n.width - e.width), a < 0 && (a = 0)),
    ...
    getCaretPosition: function (t, e, i) {
      ...
      'left' === h ? (a = (n = f) - d, o = n, r = s + d, l = s - d)  : (a = (n = f + p) + d, o = n, r = s - d, l = s + d);
       else if ('left' === h ? (n = (a = f + u + d) - d, o = a + d)  : 'right' === h ? (n = (a = f + p - u - d) - d, o = a + d)  : (n = (a = i.caretX) - d, o = a + d), 'top' === c) s = (r = g) - d,
      l = r;
       else {
        s = (r = g + m) + d,
        l = r;
    ...
    drawTitle: function (t, e, i) {
      ...
      if (n.length) {
        ...
        r = e.titleFontSize,
        s = e.titleSpacing;
        for (i.fillStyle = e.titleFontColor, i.font = ut.fontString(r, e._titleFontStyle, e._titleFontFamily), a = 0, o = n.length; a < o; ++a) i.fillText(n[a], t.x, t.y),
        t.y += r + s,
    ...
    handleEvent: function (t) {
      ...
      (e = !ut.arrayEquals(i._active, i._lastActive)) && (i._lastActive = i._active, (n.enabled || n.custom) && (i._eventPosition = {
        x: t.x,
        y: t.y
      }, i.update(!0), i.pivot())),
      e
    ...
    return ut.merge({
      ...
      merger: function (t, e, i, n) {
        if ('xAxes' === t || 'yAxes' === t) {
          ...
          !e[t][a].type || r.type && r.type !== e[t][a].type ? ut.merge(e[t][a], [
            He.getScaleDefaults(o),
            r
          ])  : ut.merge(e[t][a], r)
  ...
  function ei() {
    return ut.merge({
      ...
      merger: function (t, e, i, n) {
        ...
        o = i[t];
        'scales' === t ? e[t] = ti(a, o)  : 'scale' === t ? e[t] = ut.merge(a, [
  ...
  ut.extend(ni.prototype, {
    ...
    buildOrUpdateScales: function () {
      ...
      e.scales && (n = n.concat((e.scales.xAxes || [
      ]).map(function (t) {
        return {
          options: t,
          dtype: 'category',
      ...
      ut.each(n, function (e) {
        ...
        a[o] = !0;
        var s = null;
        if (o in i && i[o].type === r) (s = i[o]).options = n,
        s.ctx = t.ctx,
        s.chart = t;
         else {
    ...
    buildOrUpdateControllers: function () {
      ...
      return ut.each(t.data.datasets, function (i, n) {
        ...
        if (a.type && a.type !== o && (t.destroyDatasetMeta(n), a = t.getDatasetMeta(n)), a.type = o, a.controller) a.controller.updateIndex(n),
    ...
    updateDataset: function (t) {
      ...
      !1 !== Ee.notify(this, 'beforeDatasetUpdate', [
        i
      ]) && (e.controller.update(), Ee.notify(this, 'afterDatasetUpdate', [
        i
      ]))
    },
    render: function (t) {
    ...
    draw: function (t) {
      ...
      e.transition(t),
      e.width <= 0 || e.height <= 0 || !1 !== Ee.notify(e, 'beforeDraw', [
        t
      ]) && (ut.each(e.boxes, function (t) {
        t.draw(e.chartArea)
      }, e), e.drawDatasets(t), e._drawTooltip(t), Ee.notify(e, 'afterDraw', [
        t
      ]))
    },
    transition: function (t) {
      for (var e = 0, i = (this.data.datasets || [
      ]).length; e < i; ++e) this.isDatasetVisible(e) && this.getDatasetMeta(e).controller.transition(t);
      this.tooltip.transition(t)
    },
    drawDatasets: function (t) {
      var e = this;
      if (!1 !== Ee.notify(e, 'beforeDatasetsDraw', [
        t
      ])) {
        for (var i = (e.data.datasets || [
        ]).length - 1; i >= 0; --i) e.isDatasetVisible(i) && e.drawDataset(i, t);
        Ee.notify(e, 'afterDatasetsDraw', [
          t
        ])
      }
    },
    drawDataset: function (t, e) {
      ...
      !1 !== Ee.notify(this, 'beforeDatasetDraw', [
        n
      ]) && (i.controller.draw(e), Ee.notify(this, 'afterDatasetDraw', [
        n
      ]))
    },
    _drawTooltip: function (t) {
      ...
      !1 !== Ee.notify(this, 'beforeTooltipDraw', [
        i
      ]) && (e.draw(), Ee.notify(this, 'afterTooltipDraw', [
        i
      ]))
    },
  ...
  li = {
    formatters: {
      ...
      linear: function (t, e, i) {
        ...
        o = '';
        if (0 !== t) if (Math.max(Math.abs(i[0]), Math.abs(i[i.length - 1])) < 0.0001) {
  ...
  var fi = pt.extend({
    ...
    beforeUpdate: function () {
      ut.callback(this.options.beforeUpdate, [
        this
      ])
    },
    update: function (t, e, i) {
      ...
      }, d.beforeSetDimensions(), d.setDimensions(), d.afterSetDimensions(), d.beforeDataLimits(), d.determineDataLimits(), d.afterDataLimits(), d.beforeBuildTicks(), s = d.buildTicks() || [
      ], s = d.afterBuildTicks(s) || s, d.beforeTickToLabelConversion(), o = d.convertTicksToLabels(s) || d.ticks, d.afterTickToLabelConversion(), d.ticks = o, n = 0, a = o.length; n < a; ++n) r = o[n],
    ...
    afterUpdate: function () {
      ut.callback(this.options.afterUpdate, [
        this
      ])
    },
    beforeSetDimensions: function () {
      ut.callback(this.options.beforeSetDimensions, [
        this
      ])
    },
    ...
    afterSetDimensions: function () {
      ut.callback(this.options.afterSetDimensions, [
        this
      ])
    },
    beforeDataLimits: function () {
      ut.callback(this.options.beforeDataLimits, [
        this
      ])
    },
    determineDataLimits: ut.noop,
    afterDataLimits: function () {
      ut.callback(this.options.afterDataLimits, [
        this
      ])
    },
    beforeBuildTicks: function () {
      ut.callback(this.options.beforeBuildTicks, [
        this
      ])
    },
    buildTicks: ut.noop,
    afterBuildTicks: function (t) {
      var e = this;
      return ut.isArray(t) && t.length ? ut.callback(e.options.afterBuildTicks, [
        e,
        t
    ...
    beforeTickToLabelConversion: function () {
      ut.callback(this.options.beforeTickToLabelConversion, [
        this
      ])
    },
    ...
    afterTickToLabelConversion: function () {
      ut.callback(this.options.afterTickToLabelConversion, [
        this
      ])
    },
    beforeCalculateTickRotation: function () {
      ut.callback(this.options.beforeCalculateTickRotation, [
        this
      ])
    },
    ...
    afterCalculateTickRotation: function () {
      ut.callback(this.options.afterCalculateTickRotation, [
        this
      ])
    },
    beforeFit: function () {
      ut.callback(this.options.beforeFit, [
        this
      ])
    },
    fit: function () {
    ...
    afterFit: function () {
      ut.callback(this.options.afterFit, [
        this
      ])
    },
    ...
    _autoSkip: function (t) {
      ...
      for (d > u && (s = 1 + Math.floor(d / u)), r > l && (s = Math.max(s, 1 + Math.floor(r / l))), e = 0; e < r; e++) i = t[e],
      ...
      if (e._isVisible()) {
        ...
        if (ut.each(b, function (n, s) {
          if (!ut.isNullOrUndef(n.label)) {
            ...
            z,
            B = n.label;
            s === e.zeroLineIndex && i.offset === h.offsetGridLines ? (l = h.zeroLineWidth, d = h.zeroLineColor, u = h.zeroLineBorderDash || [
            ], c = h.zeroLineBorderDashOffset || 0)  : (l = ui(h.lineWidth, s), d = ui(h.color, s), u = h.borderDash || [
            ...
            if (m) {
              ...
              'top' === f ? (M = L(r, t.top, F) + F / 2, I = t.bottom, O = ((g ? 1 : 0.5) - N) * k, z = g ? 'left' : 'center', R = e.bottom - V)  : (M = t.top, I = L(r, t.bottom, F) - F / 2, O = (g ? 0 : 0.5) * k, z = g ? 'right' : 'center', R = e.top + V)
            } else {
              var E = (p ? 0 : S) + _;
          ...
          if (h.display && e && i && (s.save(), s.lineWidth = e, s.strokeStyle = i, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), h.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), h.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
            ...
            var n = t.label,
            a = t.textOffset;
            if (ut.isArray(n)) for (var o = 0; o < n.length; ++o) s.fillText('' + n[o], 0, a),
            a += k;
          ...
          z = 0,
          B = I.lineHeight / 2;
          if (m) R = e.left + (e.right - e.left) / 2,
  ...
  var bi = fi.extend({
    ...
    getTickLimit: function () {
      ...
      i = e.stepSize,
      n = e.maxTicksLimit;
      return i ? t = Math.ceil(this.max / i) - Math.floor(this.min / i) + 1 : (t = this._computeTickLimit(), n = n || 11),
      n && (t = Math.min(n, t)),
      t
    },
    ...
    buildTicks: function () {
      ...
      a = t.ticks = function (t, e) {
        ...
        n = Math.floor(f / p) * p,
        a = Math.ceil(g / p) * p,
        s && (!vi(u) && ut.almostWhole(u / p, p / 1000) && (n = u), !vi(h) && ut.almostWhole(h / p, p / 1000) && (a = h)),
        o = (a - n) / p,
        o = ut.almostEquals(o, Math.round(o), p / 1000) ? Math.round(o)  : Math.ceil(o),
        n = Math.round(n * i) / i,
        a = Math.round(a * i) / i,
        r.push(vi(u) ? n : u);
  ...
  function Oi(t, e, i, n) {
    ...
    o,
    r = i.y + n / 2;
    if (ut.isArray(e)) for (a = 0, o = e.length; a < o; ++a) t.fillText(e[a], i.x, r),
    r += n;
    ...
    draw: function () {
      ...
      if (e.display) {
        ...
        (e.angleLines.display || e.pointLabels.display) && function (t) {
          ...
          e.lineWidth = r,
          e.strokeStyle = s,
          e.setLineDash && (e.setLineDash(Ai([n.borderDash,
          a.borderDash,
          [
          ]])), e.lineDashOffset = Ai([n.borderDashOffset,
          a.borderDashOffset,
          0]));
        ...
        ut.each(t.ticks, function (e, s) {
          if (s > 0 || n.reverse) {
            ...
            if (i.display && 0 !== s && function (t, e, i, n) {
              ...
              if ((r || s) && l && d) {
                if (o.save(), o.strokeStyle = l, o.lineWidth = d, o.setLineDash && (o.setLineDash(e.borderDash || [
                ]), o.lineDashOffset = e.borderDashOffset || 0), o.beginPath(), r) o.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI);
                 else {
                  a = t.getPointPosition(0, i),
                  o.moveTo(a.x, a.y);
                  for (var u = 1; u < s; u++) a = t.getPointPosition(u, i),
                  o.lineTo(a.x, a.y)
                }
                o.closePath(),
                o.stroke(),
  ...
  var Ji = fi.extend({
    ...
    determineDataLimits: function () {
      ...
      for (t = 0, i = (s.data.datasets || [
      ]).length; t < i; ++t) if (s.isDatasetVisible(t)) if (a = s.data.datasets[t].data, ut.isObject(a[0])) for (g[t] = [
      ], e = 0, n = a.length; e < n; ++e) o = Gi(r, a[e]),
      f.push(o),
      g[t][e] = o;
       else {
    ...
    n._table = function (t, e, i, n) {
      ...
      for (u.push(i), a = 0, o = u.length; a < o; ++a) l = u[a + 1],
      r = u[a - 1],
      s = u[a],
...
function (t, e, i) {
  ...
  for (n = 0, a = e.length; n < a; ++n) o = e[n],
...
if (n = parseFloat(o, 10), isFinite(n) && Math.floor(n) === n) return '-' !== o[0] && '+' !== o[0] || (n = e + n),
!(n === e || n < 0 || n >= i) && n;
switch (o) {
case 'bottom':
return 'start';
...
s && l && r.length && (ut.canvas.clipArea(n, t.chartArea), function (t, e, i, n, a, o) {
  ...
  v = 0,
  b = 0;
  for (t.beginPath(), r = 0, s = f + !!o; r < s; ++r) u = i(d = e[l = r % f]._view, l, n),
  h = ln(d),
  c = ln(u),
  h && c ? (v = p.push(d), b = m.push(u))  : v && b && (g ? (h && p.push(d), c && m.push(u))  : (dn(t, p, m, v, b), v = b = 0, p = [
  ], m = [
  ]));
  dn(t, p, m, v, b),
  t.closePath(),
...
i = ut.callback(e.generateLabels, [
t.chart
], t) || [
];
...
e.textBaseline = 'middle';
var g = i.text;
if (ut.isArray(g)) for (var p = 0, m = 0; m < g.length; ++m) e.fillText(g[m], 0, p, n),
p += s;
...
if (ut.isFinite(t)) {
for (var e = 1, i = 0; Math.round(t * e) / e !== t; ) e *= 10,
i++;
return i
}
},
